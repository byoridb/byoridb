...
Non-root user records are durable and hydrated into the authentication cache at
startup, but sessions and active authentication state remain process-local.
