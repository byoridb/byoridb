...
취약점으로 의심되는 내용은 public issue로 열지 마세요. [SECURITY.ko.md](SECURITY.ko.md)의
비공개 제보 절차를 따르세요.
...
전체 workspace를 format하고 lint합니다.
...
모든 test를 직렬 실행합니다. 임시 redb database가 file/lock을 두고 경합할 수 있어
직렬 실행이 필수입니다.
...
최종 gate는 여전히 전체 workspace 명령입니다.
